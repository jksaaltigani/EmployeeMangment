...
Route::middleware(['auth', 'email'])->group(function () {
    ...
    ########################## users route ######################
    Route::prefix('users')->middleware('can:users')->group(function () {
        Route::resource('user', UserController::class);
    });

    ######################### company route #####################

    Route::prefix('company')->middleware('can:company')->group(function () {
    ...
    Route::prefix('companyCategories')->middleware('can:category')->group(function () {
    ...
    ####################### jobs route ###############3
    Route::prefix('jobs')->middleware('can:jobs')->group(function () {
    ...
    Route::prefix('Employee')->middleware('can:employee')->group(function () {
        Route::resource('employee', EmployeeController::class);
        Route::get('status', [EmployeeController::class, 'status'])->name('employee.status');
    });
    ######################## employeee Attachment #################

    Route::prefix('attachment')->middleware('can:employee')->group(function () {
    ...
    Route::prefix('details')->middleware('can:employee')->group(function () {
        Route::resource('details', EmployeeDetilesController::class);
    });

    Route::prefix('salary')->middleware('can:salary')->group(function () {
